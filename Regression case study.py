...
cars['vehicleType'].value_counts()  # vehicleType affects price
pd.crosstab(cars['vehicleType'], columns='count', normalize=True)
sns.countplot(x='vehicleType', data=cars)
sns.boxplot(x='vehicleType', y='price', data=cars)

cars['gearbox'].value_counts()  # gearbox affects price
...
cars['fuelType'].value_counts() # fuelType affects price
